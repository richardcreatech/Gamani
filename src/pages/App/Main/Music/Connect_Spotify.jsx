    ...
    <main className="spotify-page">
      ...
      <div className="spotify-mascot">
        <div className="mascot__body">
          ...
          <div className="mascot__mouth">u</div>
        </div>
      ...
      <section className="spotify-card">
        ...
        <p className="spotify-card__eyebrow">OH, HELLO THERE</p>
        ...
        <p className="spotify-card__description">
          Connect your Spotify account and let your music come hang out with us.
        </p>

        <button className="spotify-card__button" onClick={connectSpotify}>
          <span className="spotify-card__button-icon">♪</span>
          Connect Spotify
          <span className="spotify-card__button-arrow">→</span>
        </button>
      ...
      <p className="spotify-page__footer">music makes things less weird</p>
    </main>
  );
}
